...
class mono_data_rx(RegisterHardwareLayer):
    ...
    _registers = {'RESET': {'descr': {'addr': 0, 'size': 8, 'properties': ['writeonly']}},
          ...
          'CONF_START_FREEZE': {'descr': {'addr': 4, 'size': 16}},
          'CONF_STOP_FREEZE': {'descr': {'addr': 6, 'size': 16}},
          'CONF_START_READ': {'descr': {'addr': 8, 'size': 16}},
          'CONF_STOP_READ': {'descr': {'addr': 10, 'size': 16}},
          'CONF_STOP': {'descr': {'addr': 12, 'size': 16}},
