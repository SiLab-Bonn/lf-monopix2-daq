...
if __name__ == "__main__":
    ...
    #process_dut(raw_data_file=raw_data_file, trigger_data_format=2, analyze_m26_header_ids=[1,2,3,4,6])
    pool = Pool()
    results = [pool.apply_async(process_dut, kwds={'raw_data_file': raw_data_file, 'trigger_data_format': 2, 'analyze_m26_header_ids':[1,2,3,4,6]}) for raw_data_file in raw_data_files]
