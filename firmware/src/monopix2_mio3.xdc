...
# DOUT[0]
set_property PACKAGE_PIN AD21 [get_ports ResetBcid]
set_property IOSTANDARD LVCMOS33 [get_ports ResetBcid]

# DOUT[1]
set_property PACKAGE_PIN AE21 [get_ports nRst]
...
# DOUT[4]
set_property PACKAGE_PIN U24 [get_ports Read]
set_property IOSTANDARD LVCMOS33 [get_ports Read]

# DOUT[5]
set_property PACKAGE_PIN U25 [get_ports ClkBX]
...
# DOUT[6]
set_property PACKAGE_PIN W23 [get_ports Injection]
set_property IOSTANDARD LVCMOS33 [get_ports Injection]

# DOUT[7]
set_property PACKAGE_PIN W24 [get_ports En_Cnfg_Pix]
...
# DOUT[10]
set_property PACKAGE_PIN W20 [get_ports Si]
set_property IOSTANDARD LVCMOS33 [get_ports Si]

# DOUT[11]
set_property PACKAGE_PIN Y21 [get_ports ClkSR]
...
# DIN[0]
set_property PACKAGE_PIN T24 [get_ports So]
...
# DIN[4]
set_property PACKAGE_PIN R25 [get_ports TokOut]
set_property IOSTANDARD LVCMOS33 [get_ports TokOut]

# DIN[6]
set_property PACKAGE_PIN AE23 [get_ports DataOut]
