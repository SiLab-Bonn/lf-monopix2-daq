...
proc run_bit { part board xdc_file size} {
    ...
    write_bitstream -force -file $vivado_dir/../bit/monopix2_$board
...
#   exec tar -C ./output -cvzf output/$board.tar.gz $board.bin $board.mcs
}
